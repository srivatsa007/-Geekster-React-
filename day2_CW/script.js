...
// let a = React.createElement("a", {href: "https://developer.mozilla.org/en-US/"}, "the rest of MDN");
...
// console.log(heading);
// const container = React.createElement("div", {style: {display: "flex", flexDirection: "column", gap:"10px"}}, heading, p1, p2, p3);

// ReactDOM.render("container", document.getElementsByClassName("root"));
